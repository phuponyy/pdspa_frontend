    ...
    <section className="relative overflow-hidden pb-16 pt-16">
      <Container className="grid gap-12 lg:grid-cols-[1.1fr_0.9fr] lg:items-center">
        <div className="space-y-8">
          {badge ? (
            <span className="inline-flex items-center gap-2 rounded-full bg-[rgba(31,107,95,0.1)] px-4 py-1 text-xs uppercase tracking-[0.2em] text-[var(--jade)]">
              {badge}
            </span>
          ) : null}
          ...
          <div className="grid grid-cols-2 gap-4 rounded-3xl border border-[var(--line)] bg-white/80 p-4 text-xs uppercase tracking-[0.2em] text-[var(--ink-muted)] md:grid-cols-4">
        ...
        <div className="relative">
          <div className="absolute -right-8 top-12 h-24 w-24 rounded-full bg-[rgba(201,162,90,0.25)] blur-2xl" />
          <div className="absolute -left-10 bottom-6 h-28 w-28 rounded-full bg-[rgba(31,107,95,0.2)] blur-2xl" />
